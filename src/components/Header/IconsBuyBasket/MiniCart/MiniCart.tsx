...
import h from "../MiniCart/MiniCart.module.css";
import {ItemsBag} from "./ItemsBag/ItemsBag";
...
export const MiniCart = () => {
    ...
    const sorts: any = [
        {valiute: 'dollar', sort: 'rating', type: 'up'},
        {valiute: 'euro', sort: '-rating', type: 'down'},
        {valiute: 'another', sort: 'price', type: 'up'},
    ]

    const onClickSelectsList = (i: any) => {
        setIsVisible(false)
    }
    ...
    return (
        ...
        <>
            <div className={h.buy_icon_three} ref={sortRef} onClick={() => {
                ...
                <div className={h.popup}>
                    <div className={h.main_container}>
                        <div className={h.main}>
                            ...
                            <div className={h.flex_buttons}>
                                <NavLink to={'/shoppingcart'}>
                                    <button className={`${h.buttons} ${h.buttons_1}`}><span>View Bag</span></button>
                                </NavLink>
                                <NavLink to={'/main'}>
                                <button className={`${h.buttons} ${h.buttons_2}`}><span>Check Out</span></button>
                                </NavLink>
                            </div>
